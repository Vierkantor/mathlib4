...
morphism into a linearly-ordered additive monoid `f : M →+ S`, the submonoid generated
by those
points of `v` which lie in the half space where `f > 0` is generated by the subset of
such points
...
‍\[serre1965\](Ch. V, §9, Lemma 2) and it may be used to prove that the root system
has a base.
              -/]
