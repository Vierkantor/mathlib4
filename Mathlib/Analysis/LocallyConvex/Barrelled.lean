...
but this has the big advantage of working and giving sensible results over _any_
...
is a _continuous_ linear map as well.

This actually works for any _countably generated_ filter instead of `atTop : Filter ℕ`,
