...
`Unitization` of the C⋆-algebra, or indeed _any_ unital C⋆-algebra. Of course, one may do this
...
In Mathlib, we don't _define_ the spectrum of an element in a non-unital C⋆-algebra, and instead
