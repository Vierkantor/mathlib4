...
* ‍\[silvester2000\] Silvester, _Determinants of Block Matrices_, The Mathematical Gazette (2000).
-/
...
/--
The main result in Silvester's paper _Determinants of Block Matrices_: the determinant of
