...
However, with respect to a measure which is positive on non-empty open sets, _closed_ measure
...
/--
A _closed_ measure zero subset is nowhere dense. (Closedness is required: for instance, the
